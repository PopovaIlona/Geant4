  ...
  fAngleForEnergyTable(nullptr)
{
  ...
  fExitFlux      = false;
  fAngleRadDistr = false;// true; // false;
  fCompton       = false;
...
G4complex G4ChanRad::OneInterfaceXTRdEdx( G4double energy,
                                           G4double gamma,
                                           G4double varAngle ) 
{
...
// G4double G4ChanRad::SpectralAngleXTRdEdx(G4double varAngle)
// {
...
G4double G4ChanRad::SpectralXTRdEdx(G4double energy)
{
  G4int i, iMax = 8;
  G4double angleSum = 0.0;
  ...
  */
  {
    for( i = 0; i < iMax-1; i++ )
    {
      angleSum += integral.Legendre96(this,&G4ChanRad::SpectralAngleXTRdEdx,
    			   lim[i],lim[i+1]);
      // result += integral.Legendre10(this,&G4ChanRad::SpectralAngleXTRdEdx,
      //			   lim[i],lim[i+1]);
    }
  }
  return angleSum;
...
G4double G4ChanRad::AngleSpectralXTRdEdx(G4double energy)
{
...
G4double G4ChanRad::AngleXTRdEdx(G4double varAngle) 
{
  ...
  // fVarAngle = varAngle;
  // G4Integrator<G4ChanRad,G4double(G4ChanRad::*)(G4double)> integral;
  // result = integral.Legendre10(this,&G4ChanRad::AngleSpectralXTRdEdx,
...
G4double G4ChanRad::GetPlateFormationZone( G4double omega ,
                                                G4double gamma ,
                                                G4double varAngle    ) 
{
  G4double cof, lambda;
...
G4complex G4ChanRad::GetPlateComplexFZ( G4double omega ,
                                             G4double gamma ,
                                             G4double varAngle    ) 
{
...
void G4ChanRad::ComputePlatePhotoAbsCof() 
{
...
G4double G4ChanRad::GetPlateLinearPhotoAbs(G4double omega) 
{
  //  G4int i;
...
G4double G4ChanRad::GetGasFormationZone( G4double omega ,
                                              G4double gamma ,
                                              G4double varAngle   ) 
{
  G4double cof, lambda;
...
G4complex G4ChanRad::GetGasComplexFZ( G4double omega ,
                                           G4double gamma ,
                                           G4double varAngle    ) 
{
  G4double cof, length,delta, real_v, image_v;
...
G4double
G4ChanRad::OneBoundaryXTRNdensity( G4double energy,G4double gamma,
...
G4double G4ChanRad::GetStackFactor( G4double energy, G4double gamma,
                                                     G4double varAngle )
{
...
G4double G4ChanRad::XTRNSpectralAngleDensity(G4double varAngle)
{
...
G4double G4ChanRad::XTRNSpectralDensity(G4double energy)
{
  fEnergy = energy;
  G4Integrator<G4ChanRad,G4double(G4ChanRad::*)(G4double)> integral;
  return integral.Legendre96(this,&G4ChanRad::XTRNSpectralAngleDensity,
                             0.0,0.2*fMaxThetaTR) +
         integral.Legendre10(this,&G4ChanRad::XTRNSpectralAngleDensity,
...
G4double G4ChanRad::XTRNAngleSpectralDensity(G4double energy)
{
...
G4double G4ChanRad::XTRNAngleDensity(G4double varAngle) 
{
  fVarAngle = varAngle;
  G4Integrator<G4ChanRad,G4double(G4ChanRad::*)(G4double)> integral;
  return integral.Legendre96(this,&G4ChanRad::XTRNAngleSpectralDensity,
			     fMinEnergyTR,fMaxEnergyTR);
}
...
G4double G4ChanRad::GetXTRenergy( G4int    iPlace, 
                                       G4double  /* position */, 
                                       G4int    iTransfer )
{
